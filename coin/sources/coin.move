...
//         let (treasury, metadata) = coin::create_currency(witness, 6, b"SUI_PLUS", b"", b"", option::none(), ctx);
...
module coin::managed {
    ...
    fun init(witness: MANAGED, ctx: &mut TxContext) {
        ...
        let (treasury_cap, metadata) = coin::create_currency<MANAGED>(witness, 2, b"SUI_PLUS", b"SP", b"", option::none(), ctx);
        transfer::public_freeze_object(metadata);
